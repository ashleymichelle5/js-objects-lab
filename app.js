...
let pokemon1 = pokemon[111]
let pokemon2 = pokemon[142]
...
const starterpokemon = pokemon.forEach(pokemon => {
...
const pokemonToCatch = (pokemon[32])
...
game.catchPokemon = function (pokemonObj){
    ...
    if(pokeball) {
        pokeball.quantity--;
        console.log(`You caught ${pokemon.name}! Pokeballs left: ${pokeball.quantity}`);
    } else {
        console.log(`No pokeballs left to catch Pokemon!`);
    }
}

const newPokemon = (pokemon [44])
